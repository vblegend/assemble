...
module.exports = {
  entry: {
    ...
    editorexamples: './examples/editor.ts',
  },
  ...
  plugins: [
    new HtmlWebpackPlugin({ //Index.html 模板化
      ...
      hash: true
    }), new HtmlWebpackPlugin({ //editor.html 模板化
      template: "./examples/templates/template.editor.html",
      chunks: ['vendors', 'common', 'editorexamples'],
